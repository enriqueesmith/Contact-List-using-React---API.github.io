			...
			<li className="list-group-item">
				<div className="row w-100">
					<div className="col-12 col-sm-6 col-md-3 px-0">
						<img src="https://source.unsplash.com/random/100x100" alt="contactimage" className="rounded-circle mx-auto d-block img-fluid" />
					</div>
					<div className="col-12 col-sm-6 col-md-9 text-center text-sm-left">
						<div className=" float-right">
							<button className="btn" onClick={() => props.history.push('/edit/'+ (props.index))}><i className="fas fa-pencil-alt mr-3"></i></button>
